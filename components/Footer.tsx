...
import { FaGavel, FaDollarSign,FaRegCreditCard } from "react-icons/fa";

export default function Footer() {
  return (
    <footer className="bg-gray-100 py-6 border-t border-gray-200 mt-12 relative">
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <svg
          ...
          <span className="text-2xl font-bold text-gray-900">Krea AI</span>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M0 1.275h6.3v21.45H0V1.275Z" fill="#111827"></path>
            <path d="M8.1 1.275h6.3v21.45H8.1V1.275Z" fill="#111827"></path>
            <path d="M16.2 1.275H22.5v21.45H16.2V1.275Z" fill="#111827"></path>
            <path
              d="M24.75 1.275h16.5v21.45h-16.5l8.25-10.725L24.75 1.275Z"
              fill="#111827"
            ></path>
          </svg>
        </div>
      ...
      <a
        href="#"
        className="flex items-center space-x-1 bg-white border border-gray-200 shadow-md rounded-full px-3 py-2 hover:bg-gray-50 hover:shadow-lg transition cursor-pointer"
      >
        <FaGavel className="w-4 h-4 text-gray-700" />
        <span className="text-gray-700 text-sm font-medium">Legal</span>
      </a>
      ...
      <a
        ...
        className="flex items-center space-x-1 bg-white border border-gray-200 shadow-md rounded-full px-3 py-2 hover:bg-gray-50 hover:shadow-lg transition cursor-pointer"
      >
        <FaRegCreditCard className="w-4 h-4 text-gray-700" />
